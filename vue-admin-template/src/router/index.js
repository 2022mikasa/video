    ...
    children: [
      {
        ...
        meta: { title: '浏览用户', icon: 'table' }
      },
      {
        path: 'adduser',
        name: 'adduser',
        component: () => import('@/views/adduser'),
        meta: { title: '注册用户', icon: 'tree' }
      }
    ]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '分析视频列表', icon: 'table' }
      },
      {
        path: 'uploadvideo',
        name: 'uploadvideo',
        component: () => import('@/views/uploadvideo'),
        meta: { title: '上传视频', icon: 'tree' }
      }
    ]
  },
